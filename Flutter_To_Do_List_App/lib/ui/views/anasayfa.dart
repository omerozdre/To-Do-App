                ...
                return GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => GorevDetaySayfa(gorev: gorev)))
                        .then((value){
                      context.read<AnasayfaCubit>().gorevleriYukle();//detaydan dondugumuz zaman calısacak. arayuze son kişileri yükleyecek
                    });
                  },
                  child: Padding(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context) => const GorevKayitSayfa()))
              .then((value){
            context.read<AnasayfaCubit>().gorevleriYukle();//kayıttan geri dondugumuz zama calısacak
          });
        },
